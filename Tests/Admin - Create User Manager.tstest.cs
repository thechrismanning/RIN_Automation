...
namespace Rinnai_Regression
{
    ...
    public class Admin___Create_User_Manager : BaseWebAiiTest
    {
     ...
     long currentDateTime = DateTime.Now.Ticks;  
        ...
        public void Admin__Create_User_Manager_CodedStep()
        {
        ...
        public void Admin__Create_User_Manager_CodedStep1()
        {
            // Enter text 'qacustcare' in 'EditNameText'
            Actions.SetText(Pages.AddUserDrupal.EditNameText, "qamanager" + currentDateTime);
