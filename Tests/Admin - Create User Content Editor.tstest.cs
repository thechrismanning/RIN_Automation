...
namespace Rinnai_Regression
{
    ...
    public class Admin___Create_User_Content_Editor : BaseWebAiiTest
    {
     ...
     long currentDateTime = DateTime.Now.Ticks;  
        ...
        public void Admin__Create_User_Content_Editor_CodedStep()
        {
        ...
        public void Admin__Create_User_Content_Editor_CodedStep1()
        {
            // Enter text 'qacustcare' in 'EditNameText'
            Actions.SetText(Pages.AddUserDrupal.EditNameText, "qacontenteditor" + currentDateTime);
