...
namespace Rinnai_Regression
{
    ...
    public class Admin_Create_User_Manufacturer_Representative_Agency : BaseWebAiiTest
    {
     ...
     long currentDateTime = DateTime.Now.Ticks;  
        ...
        public void Admin_Create_User_Manufacturer_Representative_Agency_CodedStep()
        {
        ...
        public void Admin_Create_User_Manufacturer_Representative_Agency_CodedStep1()
        {
            // Enter text 'qacustcare' in 'EditNameText'
            Actions.SetText(Pages.AddUserDrupal.EditNameText, "qaManufacturerRepresentativeAgency" + currentDateTime);
