...
namespace Rinnai_Regression
{
    ...
    public class Admin_Create_User_Dealer : BaseWebAiiTest
    {
     ...
     long currentDateTime = DateTime.Now.Ticks;  
        ...
        public void Admin_Create_User_Dealer_CodedStep()
        {
        ...
        public void Admin_Create_User_Dealer_CodedStep1()
        {
            // Enter text 'qacustcare' in 'EditNameText'
            Actions.SetText(Pages.AddUserDrupal.EditNameText, "qadealer" + currentDateTime);
