...
namespace Rinnai_Regression
{
    ...
    public class Admin_Create_User_Regional_Sales_Director : BaseWebAiiTest
    {
     ...
     long currentDateTime = DateTime.Now.Ticks;  
        ...
        public void Admin_Create_User_Regional_Sales_Director_CodedStep()
        {
        ...
        public void Admin_Create_User_Regional_Sales_Director_CodedStep1()
        {
            // Enter text 'qacustcare' in 'EditNameText'
            Actions.SetText(Pages.AddUserDrupal.EditNameText, "qaRegionalSalesDirector" + currentDateTime);
