...
namespace Rinnai_Regression
{
    ...
    public class Admin___Create_User_Customer_Care : BaseWebAiiTest
    {
     ...
     long currentDateTime = DateTime.Now.Ticks;  
        ...
        public void Admin__Create_User_Customer_Care_CodedStep()
        {
        ...
        public void Admin__Create_User_Customer_Care_CodedStep1()
        {
            // Enter text 'qacustcare' in 'EditNameText'
            Actions.SetText(Pages.AddUserDrupal.EditNameText, "qacustcare" + currentDateTime);
